...
class BusinessSettingsController extends Controller
{
    ...
    public function max_amount_status($status)
    {
    ...
    public function free_delivery_status($status)
    {
    ...
    public function restaurant_setup(Request $request)
    {
        ...
        $curr_fav_icon = BusinessSetting::where(['key' => 'fav_icon'])->first();
        DB::table('business_settings')->updateOrInsert(['key' => 'fav_icon'], [
    ...
    public function payment_update(Request $request, $name)
    {
        ...
        if ($name == 'cash_on_delivery') {
            ...
            $payment = BusinessSetting::where('key', 'offline_payment')->first();
            if (isset($payment) == false) {
                DB::table('business_settings')->insert([
                    'key'        => 'offline_payment',
                    'value'      => json_encode([
    ...
    public function cancellation_policy()
    {
        ...
        $status = BusinessSetting::where(['key' => 'cancellation_policy_status'])->first();
        if (!$data) {
            $data = [
    ...
    public function cancellation_policy_status(Request $request)
    {
        BusinessSetting::where(['key' => 'cancellation_policy_status'])->update([
    ...
    public function refund_policy()
    {
        ...
        $status = BusinessSetting::where(['key' => 'refund_policy_status'])->first();
        if (!$data) {
            $data = [
                'key' => 'refund_policy',
                'value' => '',
    ...
    public function refund_policy_status(Request $request)
    {
        BusinessSetting::where(['key' => 'refund_policy_status'])->update([
            'value' => $request->status,
        ]);
        Toastr::success(translate('Status updated!'));
        return back();
    ...
    public function return_policy()
    {
        ...
        $status = BusinessSetting::where(['key' => 'return_policy_status'])->first();
        if (!$data) {
            $data = [
                'key' => 'return_policy',
                'value' => '',
    ...
    public function return_policy_status(Request $request)
    {
        BusinessSetting::where(['key' => 'return_policy_status'])->update([
            'value' => $request->status,
        ]);
        Toastr::success(translate('Status updated!'));
        return back();
    ...
    public function cookies_setup_update(Request $request)
    {
