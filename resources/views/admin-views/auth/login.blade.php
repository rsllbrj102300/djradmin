    ...
    <div class="auth-wrapper">
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                ...
                <h2 class="title">{{translate('D JR.')}} <span class="d-block">{{translate('Hardware Trading')}}</span> <strong class="text--039D55">{{translate('Admin Panel')}}</strong></h2>
            </div>
        </div>
                ...
                <form id="form-id" action="{{route('admin.auth.login')}}" method="post">
                    ...
                    <div class="auth-header">
                        <div class="mb-5">
                            ...
                            <div>{{translate('Sign in to start session')}}</div>
